...
![HPS/FPGA High-Level Design](https://github.com/shade-12/tag/blob/main/docs/img/High_Level_Design.png?raw=true)
...
*Traning script for these networks can be found in the `ml` directory.*
